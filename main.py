...
for i in range(len(daily_transactions_split)):
  for str in daily_transactions_split[i]:
    transactions_clean.append(str.strip())
...
for thread in thread_sold:
  if thread.find('&'):
    separate_colors = thread.split('&')
    for color in separate_colors:
...
for color in colors:
  print("Today {count} {color} threads were sold.".format(count=color_count(color), color=color))
